...
export const addSneakerCount = ({ shoes, ...rest }) => {
  let newArray = { shoes, rest, sneakerCount: shoes.length };
  return newArray;
};
...
// First try, it works but not the best way to solve...
// export const totalSneakerCount = ({ Nike, Puma, Adidas }) => {
//   let sum = 0;
//   sum += Nike.shoes.length + Puma.shoes.length + Adidas.shoes.length;
//   return sum;
// };
